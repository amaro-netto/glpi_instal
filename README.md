...
* **[Instalação do GLPI em Máquina Virtual (Debian 12)](./glpi-install-vm.md)**
...
* **[Instalação do GLPI com Docker Compose](./glpi-install-docker-compose.md)** (A ser adicionado)
